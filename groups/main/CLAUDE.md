...
After setup, **read the workspace CLAUDE.md**: `/workspace/mike-personal-workspace/CLAUDE.md` — it describes how the workspace is organized, what to read at startup, and how to maintain it. Follow its instructions.
